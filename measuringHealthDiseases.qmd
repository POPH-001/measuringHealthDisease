...
subtitle: "Eric Delmelle <br> September 11, 16 (and maybe September 18)"
format: revealjs
---
...
::: columns
::: {.column width="45%" style="font-size: 30px; line-height: 1.2;"}
- Group **John Snow**
- Group **Pasteur** 
- Group **Nightingale** 
- Group **Gupta**
...
-   0-20, 21-40, 41-60, 61+ <br><br><br>

#### Initialize Population (l₀) {style="color: blue;"}

-   Assume l₀ = 100,000 <br><br><br>
...
$$ dₓ = lₓ \times qₓ $$ - **Example:** $$ d_{0-20} = 100,000 \times 0.005 = 500 $$
...
<small> In the 2000 census, the total population of the United States was 281,423,000, with the following age-sex distribution (rounded to the nearest thousand):
